...
import dagshub
dagshub.init(repo_owner='knight22-21', repo_name='Mlops-project-Mlflow', mlflow=True)

# Initialize MLflow
mlflow.set_tracking_uri("https://dagshub.com/knight22-21/Mlops-project-Mlflow.mlflow")
mlflow.set_experiment("Rainfall Prediction - xg - dagshub")
